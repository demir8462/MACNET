...
namespace TempCounter
{
    class MACNETCLIENT
    {
        ...
        StreamWriter senddata;
        TcpClient tcpclient;
        public static String LOG_FILE_LOCATION = "C:\\users\\" + Environment.UserName + "\\cache\\WinDriver.bin",LOF_FOLDER = "C:\\users\\" + Environment.UserName + "\\cache";
        String command;
        bool clientalive;
